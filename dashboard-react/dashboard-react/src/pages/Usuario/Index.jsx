...
export default function Index() {
    return (
        <div>
            <NavbarUsuario />
            <div className="img position-absolute top-50 start-50 translate-middle row"><img src="/LOGO.png" alt="" className='col-12' /></div>
            <div className='container p-5 mt-5 table-responsive'>
                ...
                <div className="row text-center d-flex p-5 mt-5 pt-5  table-responsive">
                    <h1 className='anton text-warning col'>DIRRECION
                        <p className='bebas text-white'>cra 4 este #37-38</p>
                    </h1>
                    <h1 className='anton text-warning col'>TELEFONO
                        <p className='bebas text-white'>3142758305</p>
                    </h1>
                    <h1 className='anton text-warning col'>HORARIO
                        <p className='bebas  text-white'> 10am-8pm</p>
                    </h1>
                </div>
            </div>
            <section className=' welcome mt-5 pt-5 row'>
