    ...
    return (
        <div className='navbar border-bottom '>
            <div class="container-fluid">
                <a class="navbar-brand text-warning anton fs-2 d-none d-sm-block" href="/"><img src="LOGO.png" alt="" width="40" height="40" class="d-inline-block align-text-top mx-4 mt-1" />
                    Master Barber</a>
                <div class="d-flex ">
