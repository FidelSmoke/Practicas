      ...
      return (
            <div className='position-relative'>
                  <div className='min-vh-100 bg-dark border-end sidebar2 position-fixed shadow px-3 text-center justify-content-center'>
                              ...
                              <li>
                                    <NavLink to="/Inventario2" exact className='rounded py-2 d-inline-block  text-white fw-bold w-100 mt-3' activeClassName='active'><BsBasket3Fill className='me-2' /><span className='d-none d-lg-block'>inventario</span></NavLink>
                              </li>
                        <li>
                              <NavLink to="/Ventas" exact className='rounded py-2 d-inline-block  text-white fw-bold w-100 mt-3' activeClassName='active'><i class="bi bi-bar-chart-fill"></i> <span className='d-none d-lg-block'>Ventas</span></NavLink>
                        </li>
